...
**Check if your EVM network is supported:**
...
In the future query fees will be based on the cost of running the data lake. Currently these are in the range of 1-2 SQD ($0.30-0.50) per Mbit/s of bandwidth per month.
